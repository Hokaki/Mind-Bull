        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <h2>Add exercise</h2>
                    <form:form class="form-horizontal" role="form" method="POST" commandName="exercise" action="${pageContext.request.contextPath}/exercise/add">  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <form:input path="description" class="form-control" id="inputDescripti" placeholder="Description" />
                            </div>
                        </div>
                        <div class="form-group">                                
